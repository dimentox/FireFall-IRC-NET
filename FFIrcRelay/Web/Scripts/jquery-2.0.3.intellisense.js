intellisense.annotate(jQuery, {
  ...
  'browser': function() {
    /// <summary>Contains flags for the useragent, read from naviCustom.userAgent. This property was removed in jQuery 1.9 and is available only through the jQuery.migrate plugin. Please try to use feature detection instead.</summary>
